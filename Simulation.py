...
pam_initiale = st.sidebar.slider("PAM de base (mmHg)", min_value=50, max_value=120)

# Curseur définir la dP du patient
dp = st.sidebar.slider("Driving Pressure (dP) [cmH2O]", min_value=3, max_value=20)

# Curseur définir la PBW du patient
PBW = st.sidebar.slider("PBW", min_value=40, max_value=80)
